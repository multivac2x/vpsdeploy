...
- [x] Static domain exists and working
- [x] Run `./setup-vps.sh remove` and confirm
- [x] Domain removed from registry
- [x] Caddyfile regenerated without domain
- [x] Caddy reloaded
- [x] `https://example.com` no longer resolves (connection refused or 404 from default Caddy)
- [x] Files remain in `/var/www/example.com/` (as documented)
