...
- [x] Domain initially set up as dynamic, app running via PM2
- [x] Update `.env.deploy` to `DOMAIN_TYPE=static` (remove `DOMAIN_PORT`)
- [x] Run `setup-vps.sh`
- [x] Registry updated, PM2 process stopped and deleted
- [x] Static web root created
- [x] Caddyfile updated with file_server
- [x] Caddy reloaded
- [x] Deploy static build with `deploy.sh`
- [x] Domain now serves static site
- [x] Old app code remains in `/home/deploy/apps/` (not deleted automatically)
